...
public class mergesortTest {
	...
	CrimeADT crime3 = new CrimeADT("P3", "C1", "School", 6.32, 4.24,2);
	CrimeADT crime4 = new CrimeADT("P4", "C6", "Mall", 8.32, 13.24,3);	
	CrimeADT crime5 = new CrimeADT("P5", "C3", "School", 12.32, 14.24,4);	
	CrimeADT crime6 = new CrimeADT("P6", "C6", "School", 23, 214.24,5);	
	CrimeADT crime7 = new CrimeADT("P7", "C0", "Mall", 77.43, 644.24,6);	
